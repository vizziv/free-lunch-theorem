...
\pdfoutput=1
\usepackage{amsmath, amssymb, graphicx, subfig, mathrsfs, calc, xspace,
...
\footnotetext[1]{Massachusetts Institute of Technology, 77 Massachusetts Ave,
  Cambridge, MA 02139.}
\footnotetext[2]{Supported by an NSF Graduate Fellowship.}
\footnotetext{A preprint this paper was submitted to arXiv on November 29,
  2012.}
\renewcommand{\thefootnote}{\arabic{footnote}}

\pagestyle{myheadings}
\thispagestyle{plain}
\markboth{Tian-Yi Jiang, Ziv Scully, Yan X Zhang}{Motors and Impossible Patterns in Chip-Firing}
