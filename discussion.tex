...
patterns are possible if and only if they are nonclumpy, which, among other things, allows
...
if and only if no other vertices can fire. We can construct a motorized parallel
